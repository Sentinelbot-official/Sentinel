...
- Sensitive text fields that may contain message content (for example, AutoMod violation records) are encrypted at rest in our database
...
1. Join our support server: https://discord.gg/p7rh9sdhHD
...
- Encryption at rest for sensitive text fields that may contain message content (for example, AutoMod violation records)
